...
import icon from './pic/shogonir.png'

const loadTextureImage: (srcUrl: string) => Promise<HTMLImageElement> = (srcUrl: string) => {
...
const main = async () => {
  ...
  const textureImage = await loadTextureImage(icon)
